...
## 20268b9a7292390b0fcffdf552d9

This key will be used to authorize you to access the `dataset` and`result` APIs.
...
You’re provided with an API that gives you a list of partners, their countries, and which dates they’re available in [ISO 8601 format](https://en.wikipedia.org/wiki/ISO_8601).
...
```
https://candidate.hubteam.com/candidateTest/v3/problem/dataset?userKey=20268b9a7292390b0fcffdf552d9
```
...
```
https://candidate.hubteam.com/candidateTest/v3/problem/result?userKey=20268b9a7292390b0fcffdf552d9
```
